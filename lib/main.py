...
from gui import choose_image, dialog_msg, choice_type, gui_imagelist, hasimages
from media_setup import _media_listing as media_listing
from media_setup import _media_unique as media_unique
from provider import tmdb # import on behalf of searching when there's no ID
from provider.local import local
        ...
        if not xbmc.abortRequested:
            ...
            if setting['background']:
                ...
                if dialog_msg('yesno',
                    ...
                    runcmd = os.path.join(__addonpath__, 'viewer.py')
